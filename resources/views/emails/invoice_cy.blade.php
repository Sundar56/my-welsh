...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>Helo,</p>
            <p>Diolch am ddewis <strong>Ffa-la-la</strong>! Isod ceir manylion eich anfoneb tanysgrifiad:</p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 20px; border-collapse: collapse;">
                    <thead>
                        <tr style="background-color: #eae3f9;">
                            <th style="text-align: left; padding: 8px; border: 1px solid #ddd;">E-bost</th>
                            <th style="text-align: left; padding: 8px; border: 1px solid #ddd;">Cynllun</th>
                            <th style="text-align: right; padding: 8px; border: 1px solid #ddd;">Swm</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr style="font-weight: bold;">
                            <td colspan="2" style="text-align: right; padding: 8px; border: 1px solid #ddd;">Cyfanswm</td>
            ...
            <p>Cliciwch ar y botwm isod i fewngofnodi:</p>
